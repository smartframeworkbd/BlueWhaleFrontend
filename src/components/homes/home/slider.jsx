...
const styles = {
  ...
  overlay: {
    ...
    background:
      "linear-gradient(90deg, rgba(0,48,130,0.9) 0%, rgba(0,78,179,0.75) 50%, rgba(65,105,225,0.3) 100%)",
    zIndex: 1,
  },
  content: {
    position: "relative",
...
const products = [
  {
    ...
    description:
      "Explore a range of premium products designed to enhance your well-being and future health.",
  ...
  },
  {
    ...
    description:
      "Our curated selection of high-quality products ensures you get the best for a healthier lifestyle.",
...

  {
    ...
    description:
      "Stay ahead with products that combine the best of nature and technology for your overall wellness",
  ...
  },
  {
    ...
    description:
      "Invest in products that not only support your health but also contribute to a sustainable future.",
  ...
  },
  {
    ...
    description:
      "Choose from our top-tier products to kickstart your journey to better health and vitality.",
              ...
              <div style={styles.slider}>
                ...
                <div className="container h-100">
                  <div className="row h-100">
                    ...
                    <div
                      className="col-md-6 d-flex flex-column justify-content-center text-white"
                      style={styles.content}
                    >
                      <h2 className="display-4 mb-2" style={styles.title}>
                        {product.title}
                      </h2>
                      <p className="lead mb-4" style={styles.description}>
                        {product.shortDescription}
                      </p>
                      {/* <h2
                        className="h3 h1-md mb-3 fw-bold text-white"
                        style={{
                          ...styles.title,
                          fontSize: isMobile
                            ? "1rem"
                      ...
                      <p
                        className="lead fs-6 fs-md-5 mb-4 text-white"
                        style={{
                          ...styles.description,
                          fontSize: isMobile
                            ? "0.9rem"
                            : styles.description?.fontSize || "1.125rem",
                          lineHeight: isMobile
                            ? "1.5"
                            : styles.description?.lineHeight || "1.8",
                          zIndex: 2,
                          position: "relative",
                        }}
                      >
