    ...
    ? [
        {
          ...
          des: (
            <>
              Our support team is available Monday to Friday from 9 AM to 5 PM
              EST.
            </>
          ),
        ...
        },
        {
          ...
          title: "Send Us Email",
          des: (
            <>Drop us an email and you'll receive a reply within 24 hours.</>
          ),
          ...
          <div className="row justify-content-center">
            <div className="col-xxl-8 col-xl-9 col-lg-10">
              ...
              >
                ...
                <button type="submit" className="btn" style={{ color: "white" ,backgroundColor:"blue"}}>
                  Send message
                </button>
              </form>
            </div>
