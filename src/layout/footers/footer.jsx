      ...
      <div className="container">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="footer-widget">
                <div className="footer-contact-info">
                  ...
                  <Image
                    src={siteLogo || "/assets/img/logo/logo-final.png"}
                    height={100}
                    width={200}
                  />
                  <p>{footerText}</p>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="footer-widget">
                <div className="footer-contact-info">
                  ...
                  <h4 className="number">
                    {isSuccess && data?.data?.contactPhone}
                  </h4>
                  <h4 className="email">
                    {isSuccess && data?.data?.contactEmail}{" "}
                  </h4>
                  <p>{address}</p>
                  <ul className="footer-social list-wrap">
                    <li key={1}>
        ...
        <div className="copyright-wrap">
          <p className="copyright-text">
            Copyright ©2025. Blue Whale Trading LLC. Design & Developed By{" "}
            <span>
              {" "}
              <a target="_blank" href="http://smartframeworkbd.com/">
                Smart Framework
              </a>
            </span>
          </p>
